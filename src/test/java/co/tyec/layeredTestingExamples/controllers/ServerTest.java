...
import co.tyec.layeredTestingExamples.dao.Dao;
...
public class ServerTest
{
    ...
    public void startServer() throws IOException
    {
        ...
        ResourceConfig rc = new PackagesResourceConfig("com.athaydes.web.controllers");
    ...
    public void testGetAll() throws IOException
    {
        ...
        ClientResponse resp = service.path("services").path("stuff").accept(MediaType.TEXT_HTML).get(ClientResponse.class);
    ...
    public void testGetById() throws IOException
    {
        ...
        ClientResponse resp = service.path("services").path("stuff").path("id1").accept(MediaType.TEXT_HTML).get(ClientResponse.class);
        System.out.println("Got stuff: " + resp);
        String text = resp.getEntity(String.class);
        ...
        String text2 = service.path("services").path("stuff").path("non_existent_id").accept(MediaType.TEXT_HTML).get(String.class);
